...
import { ideal_movement } from "./assets/ideal";
...
export class Camera {
    ...
    static async setupCamera(cameraParam) {
        ...
        const videoConfig = {
            ...
            video: {
                ...
                height: isMobile() ?
                    params.VIDEO_SIZE["360 X 270"].height : $size.height,
                frameRate: {
                    ideal: targetFPS,
                },
            },
    ...
    /**
     * Draw the keypoints and skeleton on the video from the ideal JSON.
     */
    drawIdeal() {
        var pose = ideal_movement[this.frameCount % ideal_movement.length]
